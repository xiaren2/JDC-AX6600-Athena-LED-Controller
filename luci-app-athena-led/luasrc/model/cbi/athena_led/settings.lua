...
s:tab("button", translate("Button Settings"))
s:tab("led", translate("LED Indicators"))
...
-- ================= BUTTON =================
o = s:taboption("button", Value, "button_gpio", translate("Screen Button GPIO Pin"))
o.datatype = "uinteger"
o.default = "71"
o.description = translate("GPIO pin offset for the screen button (default 71 for AX6600). May differ on other firmware.")

o = s:taboption("button", Flag, "enable_mesh_button", translate("Enable Mesh Button"))
o.description = translate("Enable custom action mapping for the Mesh button.")

o = s:taboption("button", Value, "mesh_button_gpio", translate("Mesh Button GPIO Pin"))
o.datatype = "uinteger"
o.default = "72"
o:depends("enable_mesh_button", "1")
o.description = translate("GPIO pin offset for the Mesh button (default 72 for AX6600).")

o = s:taboption("button", ListValue, "mesh_short_action", translate("Mesh Short Press Action"))
o:depends("enable_mesh_button", "1")
o.default = "none"
o:value("none", translate("None"))
o:value("reboot", translate("Reboot Router"))
o:value("restart_network", translate("Restart Network"))
o:value("restart_wifi", translate("Restart Wi-Fi"))
o:value("restart_athena", translate("Restart Athena LED"))

o = s:taboption("button", ListValue, "mesh_long_action", translate("Mesh Long Press Action"))
o:depends("enable_mesh_button", "1")
o.default = "none"
o:value("none", translate("None"))
o:value("reboot", translate("Reboot Router"))
...
-- ================= LED INDICATORS =================
o = s:taboption("led", Flag, "disable_led_clock", translate("Disable Clock LED (Status 1)"))
o.default = "0"
o.description = translate("Turn off the small clock indicator LED to the right of the digits.")

o = s:taboption("led", Flag, "disable_led_medal", translate("Disable Medal LED (Status 2)"))
o.default = "0"
o.description = translate("Turn off the medal/connectivity indicator LED.")

o = s:taboption("led", Flag, "disable_led_up", translate("Disable Up Arrow LED (Status 4)"))
o.default = "0"
o.description = translate("Turn off the upload speed up-arrow indicator LED.")

o = s:taboption("led", Flag, "disable_led_down", translate("Disable Down Arrow LED (Status 8)"))
o.default = "0"
o.description = translate("Turn off the download speed down-arrow indicator LED.")
